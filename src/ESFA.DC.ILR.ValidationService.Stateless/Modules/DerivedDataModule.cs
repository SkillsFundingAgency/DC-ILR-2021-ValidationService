...
namespace ESFA.DC.ILR.ValidationService.Stateless.Modules
{
    internal class DerivedDataModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<DerivedData_35Rule>().As<IDerivedData_35Rule>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<DerivedData_39Rule>().As<IDerivedData_39Rule>().InstancePerLifetimeScope();
