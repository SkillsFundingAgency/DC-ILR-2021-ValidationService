...
{
    public class PriorAttain_08RuleTests : AbstractRuleTests<PriorAttain_08Rule>
    {
        [Fact]
        public void RuleName()
        {
            NewRule().RuleName.Should().Be("PriorAttain_08");
        }
        ...
        {
            var learnStartDate = new DateTime(2020, 08, 01);
            var fundModel = 35;
            var priorAttain = 4;
            var progType = 24;
        ...
        public void ValidateError()
        {
            var learner = new TestLearner()
            {
                ...
                LearningDeliveries = new List<TestLearningDelivery>()
                {
                    ...
                    {
                        FundModel = 35,
                        LearnStartDate = new DateTime(2020, 09, 01),
                        ProgTypeNullable = 24
                    }
                }
            };
        ...
        public void BuildErrorMessageParameters()
        {
            ...
            validationErrorHandlerMock.Setup(veh => veh.BuildErrorMessageParameter(PropertyNameConstants.LearnStartDate, "01/08/2020")).Verifiable();
            ...
            NewRule(validationErrorHandlerMock.Object).BuildErrorMessageParameters(new DateTime(2020, 8, 1), 1, 1, 1);

            validationErrorHandlerMock.Verify();
        }

        private PriorAttain_08Rule NewRule(IValidationErrorHandler validationErrorHandler = null)
        {
            return new PriorAttain_08Rule(validationErrorHandler);
        }
    }
}
