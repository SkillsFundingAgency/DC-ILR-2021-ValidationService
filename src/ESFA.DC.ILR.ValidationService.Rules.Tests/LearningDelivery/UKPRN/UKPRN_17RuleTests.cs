...
namespace ESFA.DC.ILR.ValidationService.Rules.Tests.LearningDelivery.UKPRN
{
    public class UKPRN_17RuleTests : AbstractRuleTests<UKPRN_17Rule>
    {
        ...
        public void Validate_Error()
        {
            ...
            //var rule17 = NewRuleMock();
            //rule17.Setup(x => x.FundModelConditionMet(25)).Returns(true);
            //rule17.Setup(x => x.TraineeshipConditionMet(24)).Returns(true);
            //rule17.Setup(x => x.LearningDeliveryFAMsConditionMet(learner.LearningDeliveries.FirstOrDefault().LearningDeliveryFAMs)).Returns(true);
            //rule17.Setup(x => x.FCTFundingConditionMet()).Returns(true);
            //rule17.Setup(x => x.StopNewStartsFromDateConditionMet("123", startDate)).Returns(true);
