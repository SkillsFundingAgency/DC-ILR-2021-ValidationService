...
namespace ESFA.DC.ILR.ValidationService.Rules.Tests.LearningDelivery.UKPRN
{
    public class UKPRN_19RuleTests
    {
        ...
        public void NewRuleWithNullMessageHandlerThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new UKPRN_19Rule(null, fileData.Object, commonOps.Object, fcsData.Object));
        }
        ...
        public void NewRuleWithNullFileDataThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new UKPRN_19Rule(handler.Object, null, commonOps.Object, fcsData.Object));
        }
        ...
        public void NewRuleWithNullCommonOpsThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new UKPRN_19Rule(handler.Object, fileData.Object, null, fcsData.Object));
        }
        ...
        public void NewRuleWithNullFCSDataThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new UKPRN_19Rule(handler.Object, fileData.Object, commonOps.Object, null));
        }
        ...
        public void RuleName2()
        {
            ...
            // assert
            Assert.Equal(RuleNameConstants.UKPRN_19, result);
        }
        ...
        public void HasQualifyingModelMeetsExpectation(bool expectation)
        {
            ...
            var sut = new UKPRN_19Rule(handler.Object, fileData.Object, commonOps.Object, fcsData.Object);
        ...
        public void HasQualifyingMonitorWithNullFAMsReturnsFalse()
        {
            ...
            // act
            var result = sut.HasQualifyingMonitor(mockItem.Object, sut.IsAdultEducationBudgets);
        ...
        [InlineData(FundingStreamPeriodCodeConstants.AEB_19TRN1920, true)]
        [InlineData(FundingStreamPeriodCodeConstants.AEB_AS1920, true)]
        ...
        /// <param name="candidate">The candidate.</param>
        [Theory]
        [InlineData(FundingStreamPeriodCodeConstants.AEB_19TRN1920)]
        [InlineData(FundingStreamPeriodCodeConstants.AEB_AS1920)]
        ...
        public UKPRN_19Rule NewRule()
        {
            ...
            return new UKPRN_19Rule(handler.Object, fileData.Object, commonOps.Object, fcsData.Object);
        }
    }
}
