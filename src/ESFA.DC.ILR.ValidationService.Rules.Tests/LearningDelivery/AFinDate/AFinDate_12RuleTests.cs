...
namespace ESFA.DC.ILR.ValidationService.Rules.Tests.LearningDelivery.AFinDate
{
    public class AFinDate_12RuleTests : AbstractRuleTests<AFinDate_12Rule>
    {
        ...
        public void AFinRecordWithDateMoreThanLearnActEndDate_ReturnsEntity()
        {
            ...
            dateTimeQueryServiceMock.Setup(ds => ds.AddYearsToDate(learnActEndDate, 2)).Returns(new DateTime(2019, 08, 01));

            NewRule(dateTimeQueryService: dateTimeQueryServiceMock.Object).AFinRecordWithDateGreaterThanLearnActEndDate(learnActEndDate, appFinRecord).Should().Be(appFinRecord);
        }
        ...
        public void AFinRecordWithDateMoreThanLearnActEndDate_ReturnsNull(string aFinDateString)
        {
            ...
            var dateTimeQueryServiceMock = new Mock<IDateTimeQueryService>();
            dateTimeQueryServiceMock.Setup(ds => ds.AddYearsToDate(learnActEndDate, 2)).Returns(new DateTime(2020, 08, 01));

            NewRule(dateTimeQueryService: dateTimeQueryServiceMock.Object).AFinRecordWithDateGreaterThanLearnActEndDate(learnActEndDate, appFinRecord).Should().BeNull();
        }
        ...
        public void Validate_Error()
        {
            ...
            var dateTimeQueryServiceMock = new Mock<IDateTimeQueryService>();
            dateTimeQueryServiceMock.Setup(ds => ds.AddYearsToDate(It.IsAny<DateTime>(), 2)).Returns(new DateTime(2019, 08, 01));
        ...
        public void Validate_NoError_AppFinRecordsDateMisMatch()
        {
            ...
            var dateTimeQueryServiceMock = new Mock<IDateTimeQueryService>();
            dateTimeQueryServiceMock.Setup(ds => ds.AddYearsToDate(It.IsAny<DateTime>(), 2)).Returns(new DateTime(2020, 08, 01));
        ...
        private AFinDate_12Rule NewRule(
            IDerivedData_07Rule dd07 = null,
            IDateTimeQueryService dateTimeQueryService = null,
            IValidationErrorHandler validationErrorHandler = null)
        {
            return new AFinDate_12Rule(dd07, dateTimeQueryService, validationErrorHandler);
        }
    }
}
