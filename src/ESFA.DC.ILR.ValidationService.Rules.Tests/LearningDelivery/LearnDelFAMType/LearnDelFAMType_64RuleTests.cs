...
{
    /// <summary>
    /// learning delivery funding and monitoring rule 64 tests
    /// </summary>
    public class LearnDelFAMType_64RuleTests
    {
        ...
        public void NewRuleWithNullMessageHandlerThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new LearnDelFAMType_64Rule(null, commonOps.Object, larsData.Object));
        }
        ...
        public void NewRuleWithNullCommonOpsThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new LearnDelFAMType_64Rule(handler.Object, null, larsData.Object));
        }
        ...
        public void NewRuleWithNullLarsDataThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new LearnDelFAMType_64Rule(handler.Object, commonOps.Object, null));
        }
        ...
        public void RuleName2()
        {
            ...
            // assert
            Assert.Equal(RuleNameConstants.LearnDelFAMType_64, result);
        }
        ...
        public LearnDelFAMType_64Rule NewRule()
        {
            ...
            return new LearnDelFAMType_64Rule(handler.Object, commonOps.Object, larsData.Object);
        }
    }
}
