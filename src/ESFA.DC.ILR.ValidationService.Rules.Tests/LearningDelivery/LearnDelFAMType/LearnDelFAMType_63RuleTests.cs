...
{
    /// <summary>
    /// learning delivery funding and monitoring rule 63 tests
    /// </summary>
    public class LearnDelFAMType_63RuleTests
    {
        ...
        public void NewRuleWithNullMessageHandlerThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new LearnDelFAMType_63Rule(null, commonOps.Object, larsData.Object));
        }
        ...
        public void NewRuleWithNullCommonOpsThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new LearnDelFAMType_63Rule(handler.Object, null, larsData.Object));
        }
        ...
        public void NewRuleWithNullLarsDataThrows()
        {
            ...
            // act / assert
            Assert.Throws<ArgumentNullException>(() => new LearnDelFAMType_63Rule(handler.Object, commonOps.Object, null));
        }
        ...
        public void RuleName2()
        {
            ...
            // assert
            Assert.Equal(RuleNameConstants.LearnDelFAMType_63, result);
        }
        ...
        public void HasQualifyingModelMeetsExpectation(bool expectation)
        {
            ...
            var sut = new LearnDelFAMType_63Rule(handler.Object, commonOps.Object, larsData.Object);
        ...
        [InlineData("ACT", "2", true)] // Monitoring.Delivery.ApprenticeshipFundedThroughAContractForServicesWithESFA
        ...
        public void InvalidItemRaisesValidationMessage()
        {
            ...
            // this step is the final phase of 'exclusion'
            var larsDelivery = new Mock<ILARSLearningDelivery>();
            larsDelivery
                .SetupGet(x => x.FrameworkCommonComponent)
                .Returns(21);
        ...
        public LearnDelFAMType_63Rule NewRule()
        {
            ...
            return new LearnDelFAMType_63Rule(handler.Object, commonOps.Object, larsData.Object);
        }
    }
}
