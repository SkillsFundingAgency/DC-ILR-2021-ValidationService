...
namespace ESFA.DC.ILR.ValidationService.Rules.Tests.LearningDelivery.ProgType
{
    public class ProgType_07RuleTests
    {
        ...
        [InlineData("2017-02-26", "2017-09-30", true)]
        [InlineData("2017-03-14", "2017-09-30", true)]
        [InlineData("2017-03-31", "2017-10-01", true)]
        [InlineData("2017-03-31", "2017-09-30", true)]
        [InlineData("2017-04-01", "2017-09-30", true)]
        [InlineData("2017-04-01", "2017-10-02", true)]
        ...
        [InlineData("2016-02-01", "2016-08-02", true)]
        ...
        [Theory]
        [InlineData("2016-08-01", "2017-08-02")]
