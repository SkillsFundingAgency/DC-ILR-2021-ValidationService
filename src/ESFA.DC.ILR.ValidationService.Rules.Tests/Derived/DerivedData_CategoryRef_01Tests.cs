...
{
    public class DerivedData_CategoryRef_01Tests
    {
        [Fact]
        ...
        private DerivedData_CategoryRef_01 NewDDRule(IDerivedData_35Rule dd35 = null)
        {
            return new DerivedData_CategoryRef_01(dd35);
        }
    }
}
