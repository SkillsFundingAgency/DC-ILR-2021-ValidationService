...
namespace ESFA.DC.ILR.ValidationService.Rules.Tests.Derived
{
    public class DerivedData_18RuleTests
    {
        ...
        [Theory]
        [InlineData(AimTypes.ProgrammeAim, "2018-01-01", TypeOfLearningProgramme.ApprenticeshipStandard, 1, "2018-01-01")]
        [InlineData(AimTypes.ComponentAimInAProgramme, "2018-01-10", TypeOfLearningProgramme.ApprenticeshipStandard, 1, "2018-01-01")]
        [InlineData(AimTypes.AimNotPartOfAProgramme, "2018-01-20", null, null, null)]
        [InlineData(AimTypes.ProgrammeAim, "2019-01-01", TypeOfLearningProgramme.ApprenticeshipStandard, 2, "2019-01-01")]
        [InlineData(AimTypes.ComponentAimInAProgramme, "2019-01-10", TypeOfLearningProgramme.ApprenticeshipStandard, 2, "2019-01-01")]
        ...
        public IReadOnlyCollection<ILearningDelivery> GetTestDeliveries()
        {
            ...
            candidates.Add(GetTestDelivery(AimTypes.ProgrammeAim, "2018-01-01", TypeOfLearningProgramme.ApprenticeshipStandard, 1));
            candidates.Add(GetTestDelivery(AimTypes.ComponentAimInAProgramme, "2018-01-10", TypeOfLearningProgramme.ApprenticeshipStandard, 1));
            candidates.Add(GetTestDelivery(AimTypes.AimNotPartOfAProgramme, "2018-01-20", null, null));
            candidates.Add(GetTestDelivery(AimTypes.ProgrammeAim, "2019-01-01", TypeOfLearningProgramme.ApprenticeshipStandard, 2));
            candidates.Add(GetTestDelivery(AimTypes.ComponentAimInAProgramme, "2019-01-10", TypeOfLearningProgramme.ApprenticeshipStandard, 2));
